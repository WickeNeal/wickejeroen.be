...
<template>
    <span
        ...
        @click="props.onClick"
    >
        <span v-for="(word, wordIndex) in words" :key="wordIndex" :style="{ display: 'inline-block', whiteSpace: 'nowrap' }">
            <span
        ...
        <span class="clip-rect-0 absolute -m-px h-px w-px overflow-hidden border-0 p-0 whitespace-nowrap">
            {{ props.label }}
        </span>
    </span>
</template>
