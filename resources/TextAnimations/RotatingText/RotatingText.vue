...
<template>
    <Motion tag="span" :class="cn('relative flex flex-wrap whitespace-pre-wrap', mainClassName)" v-bind="$attrs" :transition="transition" layout>
        <span class="sr-only">
        ...
        <AnimatePresence :mode="animatePresenceMode" :initial="animatePresenceInitial">
            <Motion
                ...
                tag="span"
                :class="cn(splitBy === 'lines' ? 'flex w-full flex-col' : 'relative flex flex-wrap whitespace-pre-wrap')"
                aria-hidden="true"
                layout
            >
