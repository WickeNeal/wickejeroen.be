...
<template>
    <Motion
        ...
        :class="`relative m-0 mx-auto h-[200px] w-[200px] origin-center cursor-pointer rounded-full text-center font-black text-white ${props.className}`"
    ...
    >
        <span
            ...
            :key="i"
            class="absolute inset-0 inline-block text-2xl transition-all duration-500 ease-[cubic-bezier(0,0,0,1)]"
            :style="{
