...
function extendMaterial<T extends THREE.Material = THREE.Material>(
    ...
    Object.entries(cfg.uniforms ?? {}).forEach(([key, u]) => {
        uniforms[key] =
            u !== null && typeof u === 'object' && 'value' in u ? (u as THREE.IUniform<unknown>) : ({ value: u } as THREE.IUniform<unknown>);
    });
...
watch(
    () => [props.beamWidth, props.beamHeight, props.beamNumber, props.lightColor, props.speed, props.noiseIntensity, props.scale, props.rotation],
    () => {
        initThreeJS();
    },
    { deep: true },
