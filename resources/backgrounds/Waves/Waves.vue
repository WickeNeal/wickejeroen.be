...
<template>
    <div ref="containerRef" :class="className" :style="{ backgroundColor, ...style }" class="absolute top-0 left-0 h-full w-full overflow-hidden">
        <div
            class="absolute top-0 left-0 h-[0.5rem] w-[0.5rem] rounded-full bg-[#160000]"
            :style="{
