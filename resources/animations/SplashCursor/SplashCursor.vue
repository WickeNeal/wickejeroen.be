...
<template>
    <div class="pointer-events-none fixed top-0 left-0 z-50 h-full w-full">
        <canvas ref="canvasRef" id="fluid" class="block h-screen w-screen"></canvas>
    </div>
</template>
...
onMounted(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
        ...
        if (!gl) {
            gl = (canvasEl.getContext('webgl', params) || canvasEl.getContext('experimental-webgl', params)) as WebGL2RenderingContext | null;
        }
