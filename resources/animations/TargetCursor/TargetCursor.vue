...
<template>
    <div
        ref="cursorRef"
        class="pointer-events-none fixed top-0 left-0 z-[9999] h-0 w-0 -translate-x-1/2 -translate-y-1/2 transform opacity-0 mix-blend-difference"
        :style="{ willChange: 'transform' }"
    >
        <div
            class="absolute top-1/2 left-1/2 h-1 w-1 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-white"
            :style="{ willChange: 'transform' }"
        />
        <div
            class="target-cursor-corner absolute top-1/2 left-1/2 h-3 w-3 -translate-x-[150%] -translate-y-[150%] transform border-[3px] border-r-0 border-b-0 border-white"
            :style="{ willChange: 'transform' }"
        />
        <div
            class="target-cursor-corner absolute top-1/2 left-1/2 h-3 w-3 translate-x-1/2 -translate-y-[150%] transform border-[3px] border-b-0 border-l-0 border-white"
            :style="{ willChange: 'transform' }"
        />
        <div
            class="target-cursor-corner absolute top-1/2 left-1/2 h-3 w-3 translate-x-1/2 translate-y-1/2 transform border-[3px] border-t-0 border-l-0 border-white"
            :style="{ willChange: 'transform' }"
        />
        <div
            class="target-cursor-corner absolute top-1/2 left-1/2 h-3 w-3 -translate-x-[150%] translate-y-1/2 transform border-[3px] border-t-0 border-r-0 border-white"
            :style="{ willChange: 'transform' }"
        />
    </div>
</template>
