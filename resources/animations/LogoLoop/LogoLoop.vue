...
const LogoContent = defineComponent({
    ...
    setup(props) {
        ...
        return () => {
            ...
            if (props.scaleOnHover) {
                baseClasses.push('transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120');
            }
            ...
            if (isNodeItem(props.item)) {
                ...
                if (props.scaleOnHover) {
                    imgClasses.push('transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/item:scale-120');
                }
