...
watch(
    ...
    () => {
        ...
        if (typeof props.initialPosition === 'object' && props.initialPosition.x !== undefined && props.initialPosition.y !== undefined) {
...
<template>
    <div ref="dragTargetRef" :class="[`absolute transform-gpu cursor-grab active:cursor-grabbing ${className}`]" :style="cssVars">
        <svg width="0" height="0">
            <defs>
                ...
                <filter id="dropShadow">
                    <feDropShadow dx="2" dy="4" :stdDeviation="dropShadowStdDeviation" flood-color="black" :flood-opacity="props.shadowIntensity" />
                </filter>
        ...
        <div
            class="sticker-container relative touch-none select-none sm:touch-auto"
            ref="containerRef"
            :style="{
        ...
        >
            <div class="sticker-main" :style="stickerMainStyle">
                ...
                <div class="absolute top-4 left-2 h-full w-full opacity-40" :style="{ filter: 'brightness(0) blur(8px)' }">
                    <div class="sticker-flap" :style="flapStyle">
                        <img :src="props.imageSrc" alt="" class="block" :style="shadowImageStyle" draggable="false" @contextmenu.prevent />
                    </div>
                </div>

                <div class="sticker-flap absolute left-0 h-full w-full" :style="flapStyle">
