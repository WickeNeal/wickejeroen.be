...
<template>
    <div
        ref="containerRef"
        :class="[props.className, 'relative w-[300px] max-w-full overflow-hidden rounded-[15px] border-2 border-white bg-[#222] text-white']"
        :style="props.style"
    ...
    >
        ...
        <div ref="activeRef" class="absolute inset-0 z-[2] h-full w-full" style="display: none">
            <slot name="secondContent" />
        </div>

        <div ref="pixelGridRef" class="pointer-events-none absolute inset-0 z-[3] h-full w-full" />
    </div>
</template>
