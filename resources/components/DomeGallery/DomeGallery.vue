...
<template>
    ...
    >
        <main ref="mainRef" class="absolute inset-0 grid touch-none place-items-center overflow-hidden bg-transparent select-none">
            <div
                class="grid h-full w-full place-items-center contain-layout contain-paint contain-size"
                :style="{
            ...
            >
                ...
                >
                    <div
                        ...
                        :key="`${item.x},${item.y},${i}`"
                        class="absolute -top-[999px] -right-[999px] -bottom-[999px] -left-[999px] m-auto transition-transform duration-300"
                        :data-src="item.src"
                    ...
                    >
                        <div
                            class="pointer-events-auto absolute inset-[10px] block translate-z-0 transform cursor-pointer overflow-hidden bg-transparent transition-transform duration-300 focus:outline-none"
                            role="button"
                            tabindex="0"
            ...
            <div
                class="pointer-events-none absolute inset-0 z-[3] m-auto"
                :style="{
            ...
            />
            <div
                class="pointer-events-none absolute top-0 right-0 left-0 z-[5] h-[120px] rotate-180"
                :style="{
                    background: 'linear-gradient(to bottom, transparent, var(--overlay-blur-color, #060010))',
                }"
            />
            <div
                class="pointer-events-none absolute right-0 bottom-0 left-0 z-[5] h-[120px]"
                :style="{
                    background: 'linear-gradient(to bottom, transparent, var(--overlay-blur-color, #060010))',
                }"
            />
            ...
            >
                <div
                    ref="scrimRef"
                    class="pointer-events-none absolute inset-0 z-10 bg-black/40 opacity-0 transition-opacity duration-500 ease-linear"
                    :style="{ backdropFilter: 'blur(3px)' }"
                />
                <div
                    ref="frameRef"
                    class="flex aspect-square h-full max-[1/1]:h-auto max-[1/1]:w-full"
...
const onDragMove = (e: MouseEvent | TouchEvent) => {
    ...
    const nextX = clamp(startRotation.value.x - dyTotal / props.dragSensitivity, -props.maxVerticalRotationDeg, props.maxVerticalRotationDeg);
