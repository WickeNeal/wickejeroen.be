...
import { computed, nextTick, onBeforeUnmount, onMounted, ref, useTemplateRef, watch, type CSSProperties, type VNode } from 'vue';
...
<template>
    <nav :class="containerClassName" :style="style" aria-label="Main navigation">
        ...
        >
            <span
                :class="['logo-content', 'inline-flex items-center justify-center', 'h-full w-[120px]']"
            ...
            >
                <img
                    ...
                    :src="logo as string"
                    alt="Logo"
                    class="bubble-logo block max-h-[60%] max-w-full object-contain"
                />
                <template v-else>
                    <component :is="logo" />
                </template>
        ...
        >
            <span
                class="menu-line mx-auto block rounded-[2px]"
                :style="{
                    width: '26px',
                    height: '2px',
            ...
            />
            <span
                class="menu-line short mx-auto block rounded-[2px]"
                :style="{
                    marginTop: '6px',
                    width: '26px',
                    height: '2px',
    ...
    >
        <ul
            :class="['pill-list', 'm-0 list-none px-6', 'mx-auto w-full max-w-[1600px]', 'flex flex-wrap', 'gap-x-0 gap-y-1', 'pointer-events-auto']"
            role="menu"
        ...
        >
            <li
                ...
                :key="idx"
                role="none"
                :class="['pill-col', 'flex items-stretch justify-center', '[flex:0_0_calc(100%/3)]', 'box-border']"
            >
                <a
                    role="menuitem"
                    :href="item.href"
