        ...
        <section ref="cardRef" class="pc-card">
            <div class="pc-inside">
                ...
                <div class="pc-content pc-avatar-content">
                    <img class="avatar" :src="avatarUrl" :alt="`${name || 'User'} avatar`" loading="lazy" @error="handleAvatarError" />
...
.pc-card {
    ...
    background-image:
        ...
        radial-gradient(35% 52% at 55% 20%, #00ffaac4 0%, #073aff00 100%), radial-gradient(100% 100% at 50% 50%, #00c1ffff 1%, #073aff00 76%),
...
.pc-shine::before {
    background-image:
        ...
        radial-gradient(circle at var(--pointer-x) var(--pointer-y), hsl(0, 0%, 70%) 0%, hsla(0, 0%, 30%, 0.2) 90%), var(--grain);
    background-size:
        250% 250%,
        100% 100%,
        220px 220px;
