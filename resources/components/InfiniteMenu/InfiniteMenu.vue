...
<template>
    <div class="relative h-full w-full">
        <canvas ref="canvasRef" class="h-full w-full cursor-grab overflow-hidden outline-none active:cursor-grabbing" />

        <template v-if="activeItem">
            <h2
                :class="[
                    'absolute top-1/2 hidden text-6xl font-black text-white transition-all duration-500 ease-in-out select-none xl:block',
                    isMoving ? 'pointer-events-none opacity-0 transition-all duration-100 ease-in-out' : 'pointer-events-auto opacity-100',
                ]"
                :style="{
                    left: '1.6em',
            ...
            <p
                :class="[
                    'absolute top-1/2 hidden text-2xl text-white/80 transition-all ease-in-out select-none xl:block',
                    isMoving ? 'pointer-events-none opacity-0 duration-100' : 'pointer-events-auto opacity-100 duration-500',
                ]"
                :style="{
                    right: '1%',
                    maxWidth: '10ch',
            ...
            <div
                ...
                :class="[
                    'absolute left-1/2 z-10 grid cursor-pointer place-items-center rounded-full border-4 border-black bg-purple-600 transition-all ease-in-out',
                    isMoving ? 'pointer-events-none opacity-0 duration-100' : 'pointer-events-auto opacity-100 duration-500',
                ]"
                :style="{
                    width: '60px',
            ...
            >
                <p class="relative text-2xl text-white select-none" :style="{ top: '2px' }">&#x2197;</p>
            </div>
        </template>
    </div>
</template>
