...
<template>
    <div class="w-full">
        <div
            class="infinite-scroll-wrapper relative flex w-full items-center justify-center overflow-hidden"
            ref="wrapperRef"
            :style="{
                maxHeight: maxHeight,
        ...
        >
            <div
                class="infinite-scroll-container flex cursor-grab flex-col px-4"
                ref="containerRef"
                :style="{
            ...
            >
                <div
                    ...
                    :key="index"
                    class="infinite-scroll-item relative box-border flex items-center justify-center rounded-2xl border-2 border-white p-4 text-center text-xl font-semibold select-none"
                    :style="{
...
const getTiltTransform = (): string => {
    ...
    return props.tiltDirection === 'left' ? 'rotateX(20deg) rotateZ(-20deg) skewX(20deg)' : 'rotateX(20deg) rotateZ(20deg) skewX(-20deg)';
};
