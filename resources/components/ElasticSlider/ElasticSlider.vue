...
<template>
    <div :class="`flex w-48 flex-col items-center justify-center gap-4 ${className}`">
        <div
            class="flex w-full touch-none items-center justify-center gap-4 select-none"
            :style="{
                scale: scale,
        ...
        >
            ...
            <div
                ref="sliderRef"
                class="relative flex w-full max-w-xs flex-grow cursor-grab touch-none items-center py-4 select-none"
            ...
            >
                ...
                >
                    <div class="relative h-full flex-grow overflow-hidden rounded-full bg-gray-400">
                        <div class="absolute h-full rounded-full bg-[#27FF64]" :style="{ width: `${rangePercentage}%` }" />
                    </div>
                </div>
            </div>
        ...
        <p class="absolute -translate-y-6 transform font-medium tracking-wide text-gray-400">{{ Math.round(value) }}</p>
    </div>
</template>
